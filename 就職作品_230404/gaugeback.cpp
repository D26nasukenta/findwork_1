...
void GaugeBack::Draw()
{
...

	{
		...
		vertex[0].Position = D3DXVECTOR3(SCREEN_WIDTH/2 - 30.0f, SCREEN_HEIGHT/2 -7.0f, 0.0f);
		vertex[0].Normal = D3DXVECTOR3(0.0f, 0.0f, 0.0f);
		vertex[0].Diffuse = D3DXVECTOR4(1.0f, 1.0f, 1.0f, m_alpha);
		vertex[0].TexCoord = D3DXVECTOR2(0, 0);


		vertex[1].Position = D3DXVECTOR3(SCREEN_WIDTH / 2 + 30.0f , SCREEN_HEIGHT / 2 - 7.0f, 0.0f);
		vertex[1].Normal = D3DXVECTOR3(0.0f, 0.0f, 0.0f);
		vertex[1].Diffuse = D3DXVECTOR4(1.0f, 1.0f, 1.0f, m_alpha);
		vertex[1].TexCoord = D3DXVECTOR2(1, 0);


		vertex[2].Position = D3DXVECTOR3(SCREEN_WIDTH /2 -30.0f, SCREEN_HEIGHT /2 + 7.0f, 0.0f);
		vertex[2].Normal = D3DXVECTOR3(0.0f, 0.0f, 0.0f);
		vertex[2].Diffuse = D3DXVECTOR4(1.0f, 1.0f, 1.0f, m_alpha);
		vertex[2].TexCoord = D3DXVECTOR2(0, 1);


		vertex[3].Position = D3DXVECTOR3(SCREEN_WIDTH /2 + 30.0f, SCREEN_HEIGHT /2 + 7.0f, 0.0f);
		vertex[3].Normal = D3DXVECTOR3(0.0f, 0.0f, 0.0f);
...
void GaugeBack::SetAlpha(bool trans)
{
	m_trans = trans;
}
