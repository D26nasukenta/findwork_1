...
ID3D11Buffer* Renderer::m_CameraBuffer = NULL;//カメラをレンダラーに追加
...
void Renderer::Begin()
{
	...
	//ImGui::ShowDemoWindow();//mainの105行
	...
	//	ImVec4 clear_color = ImVec4(f, 0.55f, 0.60f, 1.00f);
...
{
	D3DXVECTOR4 temp(CameraPosition.x, CameraPosition.y, CameraPosition.z, 1.0f);
